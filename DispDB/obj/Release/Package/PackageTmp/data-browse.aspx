...
<div class="Filter">
    ...
    请选择数据库：
        <select name="db" id="db">
            <option value="192.168.100.48:BTPreservation32">192.168.100.48:BTPreservation31</option>
...
<script>
    ...
    function checkDiffer(data){
        ...
        $.each(data, function( key, val ) {
            ...
            if(val[0][0]!=undefined){
                ...
                souceHtml += '<li class="i t '+souceTableClass+'" id="'+val[0][0]['table_name'].trim()+'"><a>'+val[0][0]['table_name'].trim()+' <i class="i">【'+val[0][0]['column_info']+'】</i></a><ul>';
    ...
    function resize(){
        ...
        var windowwt = ($(window).width()-10);
        var h = windowht-$('.Filter').height()-10;
